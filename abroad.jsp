	...
	<div id="left" >
		...
		<div id="afterload" align="center" >
			<table width="95%" >
				...
				<tr height="50"><td width="28%"><img src="<%=basePath %>/images/userimg/<%=session.getAttribute("userimg") %>.gif" width="50" height="50"/></td><td align="center">欢迎进入点餐系统！<br>尊敬的<label id="carsze" style="color:highlight; font-size: 14px;"><%=session.getAttribute("nackname") %></label>用户，您好！</td></tr>
	...
	<div id="center" align="left">
		...
		<div id="showfood" align="center">
			<table width="95%" height="453">
				<tr><td align="left" height="33"><span class="STYLE1">西餐</span><br></td>
				<td align="right">
