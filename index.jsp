...
<div id="content">
	<div id="left" >
		...
		<div id="afterload" align="center" >
			<table width="95%" >
				...
				<tr height="50"><td width="28%"><img src="<%=basePath %>/images/userimg/<%=session.getAttribute("userimg") %>.gif" width="50" height="50"/></td><td align="center">欢迎进入点餐系统！<br>尊敬的<label id="carsiz" style="color:highlight; font-size: 14px;"><%=session.getAttribute("nackname") %></label>用户，您好！</td></tr>
	...
	<div id="center" align="left">
		<div id="ad"><script type="text/javascript" src="js/indexflash.js"></script></div>
		<div id="news" align="center">
			<table width="95%" >
				<tr><td colspan="3"><span class="STYLE1">最新消息</span></td></tr>
				<%
					sql = "select * from t_o_Com where o_cType = '消息'";
				...
				%>
							<tr><td>·</td><td><a href="composition?news=<%=combean.getC_no() %>" target="_blank"><%=combean.getC_title() %></a></td><td align="right">(<%=combean.getC_date() %>)</td></tr>
				<%}}else{
					for(int i=size-1;i>=size-10;i--){
							combean = comList.get(i);
				%>
							<tr><td>·</td><td><a href="12.jsp"><%=combean.getC_title() %></a></td><td align="right">(<%=combean.getC_date() %>)</td></tr>
				<%}
				} %>
			</table>
		</div>
		<div id="allfood" align="center" >
			<table width="95%" align="center">
				<%
					ArrayList<foodBean> foodList = new ArrayList<foodBean>();
				%>
				<tr><td colspan="2"><span class="STYLE1">本店食物</span></td>
				...
				<%
					...
					size = foodList.size();
					foodbean = foodList.get(size-1);
				%>
					<td width="100"><a href="foodmessage?no=<%=foodbean.getFood_no() %>" target="_self"><img src="images/foodimg/<%=foodbean.getFood_no() %>.jpg" width="120" height="100"/></a><br/></td>
					<td width="220"><table width="100%"><tr><td><span class="STYLE1">招牌菜</span></td><td align="right"><a href="foodlist?foodtype=my">more</a></td></tr><tr>
					<%
						int row = 0;
						for(int i=size-1;i>size-7;i--){
							...
							row++;
					%>
							<td width="50%"><a href="foodmessage?no=<%=foodbean.getFood_no() %>" target="_self"><%=foodbean.getFood_name() %></a></td>
					<%
							if(row%2==0){
								if(row!=6){
									out.print("</tr>");
					...
					<%
						...
						foodbean = foodList.get(size-1);
					%>
					<td width="100"><a href="foodmessage?no=<%=foodbean.getFood_no() %>" target="_self"><img src="images/foodimg/<%=foodbean.getFood_no() %>.jpg" width="120" height="100"/></a></td>
					<td width="220">
					<table width="100%" ><tr><td ><span class="STYLE1">中餐</span></td><td align="right"><a href="foodlist?foodtype=china">more</a></td></tr><tr>
					<%
						row = 0;
						for(int i=size-1;i>size-7;i--){
							foodbean = foodList.get(i);
				...
				<tr height="120">
					<%
						...
						foodbean = foodList.get(size-1);
					%>
					<td><a href="foodmessage?no=<%=foodbean.getFood_no() %>" target="_self">
					<img src="images/foodimg/<%=foodbean.getFood_no() %>.jpg" width="120" height="100"/></a></td>
					<td  width="220">
						<table width="100%" ><tr><td><span class="STYLE1">西餐</span></td><td align="right"><a href="foodlist?foodtype=abroad">more</a></td></tr><tr>
					<%
						row = 0;
						for(int i=size-1;i>size-7;i--){
							foodbean = foodList.get(i);
					...
					<img src="images/foodimg/<%=foodbean.getFood_no() %>.jpg" width="120" height="100"/></a></td>
					<td  width="220">
						<table width="100%"><tr><td ><span class="STYLE1">小吃</span></td><td align="right"><a href="foodlist?foodtype=nosh">more</a></td></tr><tr>
					<%
						row = 0;
						for(int i=size-1;i>size-7;i--){
							foodbean = foodList.get(i);
				...
				<%
						...
						foodbean = foodList.get(size-1);
					%>
					<td><a href="foodmessage?no=<%=foodbean.getFood_no() %>" target="_self"><img src="images/foodimg/<%=foodbean.getFood_no() %>.jpg" width="120" height="100"/></a></td>
					<td  width="220"><table width="100%" ><tr><td><span class="STYLE1">糕点</span></td><td align="right"><a href="foodlist?foodtype=cake">more</a></td></tr><tr>
					<%
						row = 0;
						for(int i=size-1;i>size-7;i--){
							foodbean = foodList.get(i);
					...
					<td><a href="foodmessage?no=<%=foodbean.getFood_no() %>" target="_self">
					<img src="images/foodimg/<%=foodbean.getFood_no() %>.jpg" width="120" height="100"/></a></td>
					<td  width="220"><table width="100%"><tr><td ><span class="STYLE1">饮品</span></td><td align="right"><a href="foodlist?foodtype=drink">more</a></td></tr><tr>
					<%
						row = 0;
						for(int i=size-1;i>size-7;i--){
							foodbean = foodList.get(i);
