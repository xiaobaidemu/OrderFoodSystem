	...
	<div id="left" >
		...
		<div id="hotfood">
			<table width="95%">
				...
				%>
					<tr height="96">
					<td width="100"><a href="foodmessage?no=<%=foodbean.getFood_no() %>" target="_self"><img src="images/foodimg/<%=foodbean.getFood_no() %>.jpg" width="100" height="80"/></a></td>
					<td><a href="foodmessage?no=<%=foodbean.getFood_no() %>" target="_self"><%=foodbean.getFood_name() %></a><br/>价格：<%=foodbean.getFood_price() %>元<br/>
	...
	<div id="center" align="left">
		...
		<div id="showfood" align="center">
			<table width="95%" height="453" >
				<tr><td align="left" height="33"><span class="STYLE1">糕点</span><br></td>
				<td align="right">
