	...
	<div id="center" align="left">
		<div id="health" align="center">
			<table width="95%" width="95%">
				...
				%>
							<td>·</td><td><a href="<%=basePath%>composition?news=<%=combean.getC_no() %>" target="_blank"><%=combean.getC_title() %></a></td>
		...
		<div id="showfood" align="center">
			<table width="95%" height="453" >
				<tr><td align="left" height="33"><span class="STYLE1">中餐</span><br></td>
				<td align="right">
